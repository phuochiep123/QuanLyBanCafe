...
public class frmTrangChu extends JFrame implements MouseListener{
	...
	public frmTrangChu() {
        ...
        btnNewButton_2.setIcon(new ImageIcon(frmTrangChu.class.getResource("/icon/iconclose.png")));
        btnNewButton_2.setBounds(205, 0, 24, 21);
        panel.add(btnNewButton_2);
        
        JPanel panel_9 = new JPanel();
        panel_9.setBounds(0, 173, 229, 507);
        pnlMenu.add(panel_9);
        panel_9.setLayout(new GridLayout(7, 1, 0, 0));
        
        controlFlag = new JPanel();
        controlFlag = pnlNoiDung;
       
        
        pnlNoiDung = new JPanel();
        pnlNoiDung.setBounds(10, 58, 1491, 697);
        ...
        btnMoMenu.setIcon(new ImageIcon(frmTrangChu.class.getResource("/icon/iconmenu.jpg")));
