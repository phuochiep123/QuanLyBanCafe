...
public class pnlHoaDon extends JPanel {
	...
	public pnlHoaDon() {
		...
		panel.setBounds(10, 10, 801, 363);
		add(panel);
		panel.setLayout(null);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBounds(10, 20, 781, 43);
		panel.add(panel_3);
		...
		scrollPane.setBounds(10, 61, 781, 292);
		...
		panel_1.setBounds(10, 383, 801, 288);
		add(panel_1);
		panel_1.setLayout(null);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(10, 27, 781, 251);
		...
		panel_2.setBounds(881, 62, 474, 505);
		add(panel_2);
